                ...
                <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <Select.Root
                            name="game"
                        >
                            <StyledTrigger className="bg-zinc-900 py-3 px-4 rounded text-sm flex justify-between">
                                <Select.Value
                                    className="text-sm"
                                    ...
                                    <Select.Viewport>
                                        {
                                            games.map(game => {
                                                return (
                                                    <Select.Item key={game.id} className="py-1 flex items-center gap-2 text-sm" value={game.id}>
                                                        <Select.ItemText >{game.title}</Select.ItemText>
                                                        <Select.ItemIndicator className="left-0">
                                                            <Check />
